...
export const Slider = ({ children }: Props) => {
    ...
    return (
        <div className="overflow-x-hidden border-[3px] border-primary-blue relative h-28 rounded-2xl">
            <FontAwesomeIcon icon={faChevronLeft} className='absolute left-4 top-12 z-20' onClick={() => { handleChangeSlide(-1) }} />
            ...
            <FontAwesomeIcon icon={faChevronRight} className='absolute right-4 top-12 z-20' onClick={() => { handleChangeSlide(1) }} />
        </div>
    )
}